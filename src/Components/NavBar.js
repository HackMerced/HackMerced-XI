    ...
    return (
      <div className="NavBar">
        ...
        <ul className="nav-items">
          ...
          <li><a href="https://docs.google.com/forms/d/e/1FAIpQLSdvJNPf1waAtIJPR_gGSw3Ve9H7l1S92e4DXFmjF1R2zJCp4g/viewform?usp=dialog"><button className="registerButton" id="register-button">Apply Now!</button></a></li>
        </ul>
      </div>
    );
  }
