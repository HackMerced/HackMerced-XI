    ...
    <div className="FAQ" id="faq">
      <div className="FAQ-container">
        ...
        <Grid2 className="FAQ-grid" container spacing={2} columns={{ xs: 12 }}>
          ...
          <Grid2 item size={6}>
            <FAQAccordion title='Will HackMerced XI be in-person or virtual?' description='HackMerced XI will be a fully in-person event! It will take place at the University of California, Merced. Workshop resources will also be shared in our Discord server.'/>
          </Grid2>
          <Grid2 item size={6}>
